***Задание 7 ***
- [X] Реализовать миграцию баз данных с помощью Flyway
- [X] Необходимо перенести логику работы с БД на Spring Data JPA и в платежном сервисе, и в сервисе продуктов

Исхожу из того что правиться может только продуктовый сервис, платежный "чужой" и не доступен для изменения  
================================================================
